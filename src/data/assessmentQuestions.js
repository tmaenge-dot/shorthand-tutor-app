// Enhanced NCS Assessment Questions with Vowel Differentiation
// Focuses on teaching proper vowel distinctions and usage

export const authenticAssessmentQuestions = {
  A: [
    {
      id: 'A1',
  ...
  D: [
    ...
    {
      id: 'D2',
      question: 'What is the difference between the A in "cat" and "father"?',
...
// Function to get assessment questions for a specific module
export const getModuleAssessmentQuestions = (moduleId, numberOfQuestions = 5) => {
  const moduleQuestions = authenticAssessmentQuestions[moduleId]
  
  if (!moduleQuestions) {
    return []
  }
  
  // Return all questions or a random subset
  if (numberOfQuestions >= moduleQuestions.length) {
...
export default authenticAssessmentQuestions
