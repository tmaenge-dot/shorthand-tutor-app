...
const Navigation: React.FC = () => {
  ...
  // Revenue & Business Management (Admin only)
  const revenueNavigationItems = [
    {
      text: 'Revenue Dashboard',
      icon: <TrendingUp />,
      path: '/revenue-dashboard',
      description: 'Track earnings & analytics',
      badge: 'ADMIN'
    },
    {
    ...
    },
    {
      ...
      description: 'Manage affiliate earnings',
      badge: 'ADMIN'
    }
  ]
  ...
  // Drawer content to be shared between mobile and desktop
  const drawerContent = (
    <>
      {/* User Info Section - only show on desktop */}
      {!isMobile && (
        <>
        ...
        <>
          <Box sx={{ p: 2, bgcolor: 'background.paper' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
              ...
              <Typography variant="body2" fontWeight="500">{currentSpeed} WPM</Typography>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
              <Typography variant="body2">Accuracy:</Typography>
              <Typography variant="body2" fontWeight="500">{currentAccuracy}%</Typography>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              <Typography variant="body2">Progress:</Typography>
              <Typography variant="body2" fontWeight="500">{overallProgress.percentage}%</Typography>
            </Box>
          </Box>
          <Divider />
        </>
      ...
      {/* Revenue & Business Management Section - Admin Only */}
      {userType === 'admin' && (
        <>
          <Box sx={{ px: 2, pb: 1 }}>
            <Typography variant="subtitle2" color="text.secondary" gutterBottom>
    ...
    <>
      ...
      >
        <Toolbar>
          ...
          >
            {isMobile ? 'Shorthand Tutor' : 'Shorthand Tutor - Pitman Shorthand Learning System'}
          </Typography>
          ...
          <Box sx={{ display: 'flex', gap: isMobile ? 1 : 2, alignItems: 'center' }}>
            ...
            {currentUser ? (
              <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                ...
                <Button 
                  onClick={logout}
                  startIcon={!isMobile ? <Logout /> : undefined}
                  sx={{ color: 'white', minWidth: isMobile ? 'auto' : undefined }}
                >
                  {isMobile ? <Logout /> : (currentUser.isGuest ? 'Exit' : 'Logout')}
                </Button>
              </Box>
            ) : (
